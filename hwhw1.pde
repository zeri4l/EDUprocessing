void setup() {
 ...
 /* // 펭귄 배
  ...
  /* // 눈동자
  fill(0); // 검은색
  ellipse(x - d * 0.15, y - d * 0.6, d * 0.075, d * 0.075); // 왼쪽 눈동자
  ellipse(x + d * 0.15, y - d * 0.6, d * 0.075, d * 0.075); // 오른쪽 눈동자 */
  ...
  vertex(x + d * 0.1, y - d * 0.4); 
  endShape(CLOSE);
  /* triangle(x, y - d * 0.5, x - d * 0.1, y - d * 0.4, x + d * 0.1, y - d * 0.4); // 부리 */
